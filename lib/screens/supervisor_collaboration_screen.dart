...
class CollaborationProgressScreen extends StatelessWidget {
            ...
            Expanded(
              child: StreamBuilder<List<CollaborationRequest>>(
                ...
                builder: (context, snapshot) {
                  ...
                  final sent = requests.where((r) => r.requesterId == userId).toList();
                  final received = requests
                      .where((r) => r.targetSupervisorIds.contains(userId) && r.requesterId != userId)
                      .toList();
                  ...
                  return ListView(
                    ...
                    children: [
                      if (received.isNotEmpty) ...[
                        _sectionHeader(context, Icons.inbox, 'Requests For You', _red),
                        const SizedBox(height: 8),
                        ...received.map((r) => _ReceivedCard(request: r, userId: userId)),
                        const SizedBox(height: 20),
                      ],
                      if (sent.isNotEmpty) ...[
                        _sectionHeader(context, Icons.send, 'Sent Requests', t.navy),
                        const SizedBox(height: 8),
  ...
  Widget _sectionHeader(BuildContext context, IconData icon, String label, Color color) {
    return Row(
      children: [
        ...
        Text(label,
            style: TextStyle(
                fontSize: 13, fontWeight: FontWeight.w700, color: context.appTheme.text)),
      ],
    );
  }
...
class _SentCardState extends State<_SentCard> {
  ...
  Future<void> _confirmCancel() async {
        ...
        content: Column(
          ...
          children: [
            ...
            _InfoRow('Description',
                (r.alertDescription?.isNotEmpty ?? false) ? r.alertDescription! : '—'),
          ],
        ),
        actions: [
          TextButton(
    ...
    try {
      await CollaborationService()
          .cancelCollaborationRequest(widget.request.id, widget.request.alertId);
    } finally {
  ...
  Widget build(BuildContext context) {
    ...
    final isRejected = r.status == 'rejected' || r.assistantDecision == 'refused';
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: isRejected ? _red.withValues(alpha: 0.4) : t.border),
        boxShadow: [
          BoxShadow(
      ...
      child: Column(
        ...
        children: [
          ...
          _ProgressStep(t,
            icon: r.assistantDecision == 'refused' ? Icons.cancel : Icons.pending,
            title: 'Assistant Response',
            subtitle: _assistantSubtitle(r),
            state: r.assistantDecision == 'accepted'
                ? _StepState.done
          ...
          if (!r.pmApproved && !isRejected) ...[
            ...
            Container(
              ...
              child: Row(children: [
                ...
                const SizedBox(width: 8),
                Expanded(
                  child: Text('Reviewed by assistant first, then by Production Manager.',
  ...
  String _assistantSubtitle(CollaborationRequest r) {
    if (r.assistantDecision == 'accepted') {
      return 'Accepted by ${r.assistantName ?? r.targetSupervisorNames.firstOrNull ?? "assistant"}';
    }
    if (r.assistantDecision == 'refused') {
      return 'Declined by ${r.assistantName ?? r.targetSupervisorNames.firstOrNull ?? "assistant"}';
    }
    return 'Waiting for ${r.targetSupervisorNames.firstOrNull ?? "assistant"} to respond';
  }
}
        ...
        children: [
          ...
          Row(children: [
            ...
            if (isAccepted)
              ...
              _chip('Declined', _red, _red.withValues(alpha: 0.1))
          ...
          Row(children: [
            ...
            Text(r.requesterName,
                style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: t.navy)),
          ]),
          ...
          if (r.pmApproved) ...[
            ...
            Container(
              ...
              child: Row(children: [
                ...
                const SizedBox(width: 8),
                Expanded(
                  child: Text('You accepted. Waiting for PM approval.',
                      style: const TextStyle(fontSize: 12, color: _green, fontWeight: FontWeight.w600)),
                ),
              ]),
            ),
...
class _ProgressStep extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final circleColor = isDone ? _green : isFailed ? _red : t.scaffold;
    final borderColor = isDone ? _green : isFailed ? _red : t.border;
    ...
    return Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Column(children: [
        Container(
          ...
          child: Icon(
            isDone ? Icons.check : isFailed ? Icons.close : icon,
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text(title,
                style: TextStyle(
                    ...
                    color: isDone ? t.navy : isFailed ? _red : t.muted)),
...
class _StatusBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (r.assistantDecision == 'accepted') return _badge('PM Pending', Colors.orange);
...
class _RequestCollaborationDialogState
  ...
  Future<void> _loadSupervisors() async {
    ...
    final hasActive = uid != null
        ? await _service.hasActiveCollaborationRequest(uid)
        : false;
            ...
            Container(
              ...
              child: Row(children: [
                ...
                Text('Request Collaboration',
                    style: TextStyle(
                        fontSize: 18, fontWeight: FontWeight.bold, color: t.navy)),
                const Spacer(),
                IconButton(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          Text(widget.alert.type,
                              style: TextStyle(
                                  fontSize: 13, fontWeight: FontWeight.bold, color: t.orange)),
                          const SizedBox(height: 4),
                          Text(
                      ...
                      if (_selectedSupervisors.isNotEmpty) ...[
                        ...
                        Wrap(
                          ...
                          children: _selectedSupervisors.map((sup) => Container(
                            ...
                            child: Row(mainAxisSize: MainAxisSize.min, children: [
                              ...
                              const SizedBox(width: 4),
                              GestureDetector(
                                onTap: () => setState(() => _selectedSupervisors.remove(sup)),
            ...
            Padding(
              ...
              child: Row(mainAxisAlignment: MainAxisAlignment.end, children: [
                OutlinedButton(
                  ...
                  child: Text('Cancel', style: TextStyle(fontSize: 13, color: t.muted)),
                ),
                const SizedBox(width: 12),
                ElevatedButton.icon(
                  onPressed: (_selectedSupervisors.isEmpty || _sending || _blockReason != null)
                      ? null
  ...
  Widget _buildSupervisorList(AppTheme t) {
    return Container(
      ...
      decoration: BoxDecoration(
          border: Border.all(color: t.border), borderRadius: BorderRadius.circular(8)),
        ...
        itemBuilder: (context, index) {
          ...
          return ListTile(
            ...
            title: Text(sup.fullName,
                style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600, color: t.navy)),
            subtitle: Text(sup.usine, style: TextStyle(fontSize: 11, color: t.muted)),
            trailing: isSelected
                ? const Icon(Icons.check_circle, color: _purple, size: 18)
                : null,
            selected: isSelected,
            selectedTileColor: _purple.withValues(alpha: 0.08),
            onTap: () => setState(() {
              if (isSelected) {
  ...
  Future<void> _sendRequest(BuildContext context) async {
    ...
    try {
      await _service.createCollaborationRequest(
        ...
        targetSupervisorNames: _selectedSupervisors.map((s) => s.fullName).toList(),
