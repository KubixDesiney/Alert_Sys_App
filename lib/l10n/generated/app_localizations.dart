...
abstract class AppLocalizations {
  ...
  /// No description provided for @dashboardHeaderGreeting.
  ///
  /// In en, this message translates to:
  /// **'Welcome back, {name}'**
  ...
  /// No description provided for @voiceEnrollmentPromptTitle.
  ///
  /// In en, this message translates to:
  /// **'Set up voice control'**
  String get voiceEnrollmentPromptTitle;

  /// No description provided for @voiceEnrollmentPromptBody.
  ///
  /// In en, this message translates to:
  /// **'Enroll your voice so you can claim and resolve alerts hands-free.'**
  String get voiceEnrollmentPromptBody;

  /// No description provided for @voiceEnrollmentPromptStart.
  ///
  /// In en, this message translates to:
  /// **'Start enrollment'**
  String get voiceEnrollmentPromptStart;

  /// No description provided for @voiceEnrollmentPromptDismiss.
  ///
  /// In en, this message translates to:
  /// **'Not now'**
  String get voiceEnrollmentPromptDismiss;
}
